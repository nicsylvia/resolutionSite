  ...
  return (
    <Container>
        <Wrapper>
            <First>
                <Res>Resolution</Res>
                <Pa>Maecenas pellentesque placerat <br /> quam, in finibus nisl tincidunt sed. <br />
                Aliquam magna augue, <br /> malesuada ut feugiat eget, cursus <br /> eget felis.</Pa>
                <Hold>
                    <Card><BsFacebook /></Card>
                    <Card><AiOutlineInstagram /></Card>
                    <Card><AiOutlineTwitter /></Card>
                </Hold>
            </First>
            <Second>
                <Link>Our Link</Link>
            ...
            <Fourth>
                ...
                <Navs>Terms & <br /> Conditions</Navs>
                <Navs>Support</Navs>
            </Fourth>
            <Fifth>
                <Link>Contact Us</Link>
                <H>
                    <Circle><MdCall /></Circle>
                    <Num>
